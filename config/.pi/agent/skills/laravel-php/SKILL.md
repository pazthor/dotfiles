...
For schema changes, also load [migration-agent](~/.pi/agent/skills/migration-agent/SKILL.md) when available.
...
- [migration-agent](~/.pi/agent/skills/migration-agent/SKILL.md) — safe schema changes
- [review-agent](~/.pi/agent/skills/review-agent/SKILL.md) — MR discipline
